...
```sh
$ git clone https://github.com/syedfaizan/getir-coding-assignment
$ cd getir-coding-assignment
$ npm install
$ npm start
```
...
- ##### ErrorCode: Can be one of the following values:
  ...
  - 4 - Mixed: Response has a mix of above errors

- ##### Message: is 'Success' for successful request, has error message if error is found

- ##### records: Array of Objects with fields - `key, createdAt and totalCount`
